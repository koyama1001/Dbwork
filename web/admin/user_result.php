...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  if($work)
  {
    $sql="UPDATE work SET start_time = :start_time, end_time = :end_time, break_time = :break_time WHERE id = :id" ;
    $stmt=$pdo->prepare($sql);
...
<a href="/web/admin/user_list.php"><button type="button" class="btn btn-secondary rounded-poll px-5">社員一覧に戻る</button></a>
</div>
